...
signed.xml: unsigned.xml
	JAVA_HOME=${JAVA_HOME} xmlsectool-2.0.0/xmlsectool.sh --sign --pkcs11Config pkcs11_java.cfg --keystoreProvider sun.security.pkcs11.SunPKCS11 --inFile unsigned.xml --key 'P12 Cert' --keyPassword ${PIN} --outFile signed.xml
